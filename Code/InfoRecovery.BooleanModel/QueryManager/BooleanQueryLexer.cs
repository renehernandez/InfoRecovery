...
public partial class BooleanQueryLexer : Antlr.Runtime.Lexer
{
	...
	private void mWS()
	{
		...
		try
		{
			...
			// D:\\Eduar\\uh\\5to\\si\\InfoRecovery\\Code\\InfoRecovery.BooleanModel\\Grammar\\BooleanQuery.g:12:4: ( ( ' ' | '\\t' | '\\r' | '\\n' ) )
			DebugEnterAlt(1);
			// D:\\Eduar\\uh\\5to\\si\\InfoRecovery\\Code\\InfoRecovery.BooleanModel\\Grammar\\BooleanQuery.g:12:8: ( ' ' | '\\t' | '\\r' | '\\n' )
			{
			DebugLocation(12, 8);
	...
	private void mTERM()
	{
		...
		try
		{
			int _type = TERM;
			int _channel = DefaultTokenChannel;
			// D:\\Eduar\\uh\\5to\\si\\InfoRecovery\\Code\\InfoRecovery.BooleanModel\\Grammar\\BooleanQuery.g:13:6: ( (~ ( '&' | '|' | '!' | '(' | ')' | ' ' | '\\t' | '\\r' | '\\n' ) )+ )
			DebugEnterAlt(1);
			// D:\\Eduar\\uh\\5to\\si\\InfoRecovery\\Code\\InfoRecovery.BooleanModel\\Grammar\\BooleanQuery.g:13:8: (~ ( '&' | '|' | '!' | '(' | ')' | ' ' | '\\t' | '\\r' | '\\n' ) )+
			{
			DebugLocation(13, 8);
			// D:\\Eduar\\uh\\5to\\si\\InfoRecovery\\Code\\InfoRecovery.BooleanModel\\Grammar\\BooleanQuery.g:13:8: (~ ( '&' | '|' | '!' | '(' | ')' | ' ' | '\\t' | '\\r' | '\\n' ) )+
			int cnt1=0;
